...
class PositionalEncoding(nn.Module):
    ...
    def __int__(self, d_model: int, seq_len: int, dropout: float) -> None:
        ...
        # register it as a buffer this way the tensor will be saved in the file along with the state of the model
...
class LayerNormalization(nn.Module):
    ...
    def forward(self, x):
        # usually the mean cancel the dimension to which it is applied but we want to keep it
